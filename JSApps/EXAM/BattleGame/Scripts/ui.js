var ui = (function () {
	...
	function buildGameField(gameField) {
		var html =
			'<div id="game-field" data-game-id="' + gameField.id + '">' +
				'<h2>' + gameField.title + '</h2>' +
				'<div id="blue-guesses" class="guess-holder">' +
					'<h3>' +
						gameField.blue + '\'s gueesses' +
					'</h3>' +
					buildGuessTable(gameField.blueGuesses) +
				'</div>' +
				'<div id="red-guesses" class="guess-holder">' +
					'<h3>' +
						gameField.red + '\'s gueesses' +
					'</h3>' +
					buildGuessTable(gameField.redGuesses) +
				'</div>' +
		'</div>';
		return html;
	}
