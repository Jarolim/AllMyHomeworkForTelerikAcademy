...
var persisters = (function () {
    ...
    function saveUserData(userData) {
        ...
        localStorage.setItem("username", userData.usename);
    ...
    var BattlePersister = Class.create({
        ...
        move: function (gameId, success, error) {
            var url = this.rootUrl + gameId + "/move";
            httpRequester.getJSON(url, success, error);
        },
        attack: function (gameId, success, error) {
            var url = this.rootUrl + gameId + "/attack";
            httpRequester.getJSON(url, success, error);
        },
        defend: function (gameId, success, error) {
            var url = this.rootUrl + gameId + "/defend";
            httpRequester.getJSON(url, success, error);
        }
});
