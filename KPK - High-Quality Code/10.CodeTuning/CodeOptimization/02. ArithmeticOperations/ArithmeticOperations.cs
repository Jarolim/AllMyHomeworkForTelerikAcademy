...
// Conclusions - 
// For int all operation are with almost the same performance
// For long multiplication is the fastest and division the slowest
// For float and double multiplication and division are slower then the other operations
// Decimal is slower then the other types in times - the slowest operation is division
