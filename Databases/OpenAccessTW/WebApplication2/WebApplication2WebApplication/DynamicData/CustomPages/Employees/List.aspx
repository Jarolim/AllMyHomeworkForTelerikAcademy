<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeBehind="List.aspx.cs" Inherits="WebApplication2WebApplication.Employees.List" %>
        ...
        <ContentTemplate>
            ...
            <asp:GridView ID="GridView1" runat="server" DataSourceID="GridDataSource" EnablePersistedSelection="true"
                ...
                <Columns>
					...
					<asp:DynamicField DataField="EmployeeNumber" HeaderText="EmployeeNumber"/>
					...
					<asp:DynamicField DataField="HourlySalary" HeaderText="HourlySalary"/>
