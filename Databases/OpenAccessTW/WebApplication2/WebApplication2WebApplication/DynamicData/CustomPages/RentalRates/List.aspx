<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeBehind="List.aspx.cs" Inherits="WebApplication2WebApplication.RentalRates.List" %>
        ...
        <ContentTemplate>
            ...
            <asp:GridView ID="GridView1" runat="server" DataSourceID="GridDataSource" EnablePersistedSelection="true"
                ...
                <Columns>
					...
					<asp:DynamicField DataField="RentalRateID" HeaderText="RentalRateID"/>
					<asp:DynamicField DataField="CategoryID" HeaderText="CategoryID"/>
					<asp:DynamicField DataField="Daily" HeaderText="Daily"/>
					<asp:DynamicField DataField="Weekly" HeaderText="Weekly"/>
					<asp:DynamicField DataField="Monthly" HeaderText="Monthly"/>
