<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeBehind="List.aspx.cs" Inherits="WebApplication2WebApplication.Categories.List" %>
        ...
        <ContentTemplate>
            ...
            <asp:GridView ID="GridView1" runat="server" DataSourceID="GridDataSource" EnablePersistedSelection="true"
                ...
                <Columns>
					...
					<asp:DynamicField DataField="RentalRates" HeaderText="RentalRates"/>
					<asp:DynamicField DataField="Cars" HeaderText="Cars"/>
				</Columns>
